...
* I know this plot is quite ugly, but I think it is what you are looking. This plot is limited to Excellent responses, and contains, year, state, and a variable that averages the data_value across locations within a state. 
